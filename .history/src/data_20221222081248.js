...
const PROGRAM_KEY_MAP = {
  ...
  "description":"contenu",
  "goals":"objectifs",
  "prerequisites":"etudiants",
  "enrollingLevel":"niveau",
  "graduationTarget": "niveauDeCertification",
  "cpf":"cpf",
  "durationInHours":"duree_en_heures",
  "cpfCode":"cpf_code",
  "durationInDays":"duree_en_jours",
  "id":"digiforma_id",
  "dpc": "dpc",
  "rncpCode": "rncpCode",
  "rsCode": "rsCode"
...
module.exports = {API_URL, QUERY_PROGRAMS, HEADERS, DIGIFORMA_HEADERS, DIGIFORMA_API_URL, DIGIFORMA_API_TOKEN, PROGRAM_KEY_MAP}