...
const DELAI_ACCES = (text) => `
  <div>
  <p>Le délai d'accès moyent pour cette formation est de ${delai}</p>
  <p>Merci d’utiliser le formulaire de contact ou nous joindre par téléphone ou mail pour l’organisation de votre formation.</p>
  </div>
`;
